...
class ILI9341:
    ...
    def printSensordata(self, fontPath, pmT=(20,30), pm25=(24,32), pmH=(30,32), imagePath=""):
        ...
        txt = Image.new('RGBA', base.size, (255,255,255,0))
        # get a font
        fnt_data = ImageFont.truetype(fontPath, 36)
        fnt_time = ImageFont.truetype(fontPath, 12)
        # get a drawing context
        d = ImageDraw.Draw(txt)
        ...
        posTime = (60,46)
        # draw text, full opacity
        d.text((posX[0],posY[0]), str(pm25[0]), font=fnt_data, fill=(255,255,255,255))
        d.text((posX[0],posY[1]), str(pmT[0])+"C", font=fnt_data, fill=(255,255,255,255))
        d.text((posX[0],posY[2]), str(pmH[0])+"%", font=fnt_data, fill=(255,255,255,255))
        d.text((posX[1],posY[0]), str(pm25[1]), font=fnt_data, fill=(255,255,255,255))
        d.text((posX[1],posY[1]), str(pmT[1])+"C", font=fnt_data, fill=(255,255,255,255))
        d.text((posX[1],posY[2]), str(pmH[1])+"%", font=fnt_data, fill=(255,255,255,255))
